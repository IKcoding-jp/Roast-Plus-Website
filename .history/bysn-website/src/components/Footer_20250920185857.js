        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <p className="copyright">
              © 2025 BYSN 作業記録サイト - 実際に働いているスタッフが作成
            </p>
            <div className="footer-bottom-links">
              <a href="https://www.start-line.jp/privacy/" target="_blank" rel="noopener noreferrer">スタートライン</a>
              <a href="https://www.minitt.jp/privacy/" target="_blank" rel="noopener noreferrer">ミニット</a>
            </div>
          </div>
        </div>
      </div>
